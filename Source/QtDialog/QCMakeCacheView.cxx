...
#if QT_VERSION >= QT_VERSION_CHECK(5, 9, 0)
      parentItems[0]->setData(QBrush(QColor(92, 92, 92)),
                              Qt::BackgroundRole);
      parentItems[1]->setData(QBrush(QColor(92, 92, 92)),
                              Qt::BackgroundRole);
#else
                                       ...
                                       const QCMakeProperty& prop, bool isNew)
{
  ...
  if (isNew) {
#if QT_VERSION >= QT_VERSION_CHECK(5, 9, 0)      
    this->setData(idx1, QBrush(QColor(64, 64, 64)), Qt::BackgroundRole);
    this->setData(idx2, QBrush(QColor(64, 64, 64)), Qt::BackgroundRole);
#else
